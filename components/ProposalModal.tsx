...
const ProposalModal: React.FC<ProposalModalProps> = ({ isOpen, onClose, recipe, rawMaterials }) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={`Propuesta para: ${recipe.name}`}>
